...
from flair_tagger import TritonFastNERTagger, DEVICE
...
def string_to_bytes(string, encoding="utf-8"):
    return list(bytes(string, encoding))
...
class TritonPythonModel:
    ...
    def initialize(self, args):
        ...
        self.viterbi_decoder = torch.load(
            "/models/flair-ner-english-fast-tokenization/1/viterbi_decoder.bin")

        self.model = TritonFastNERTagger(
            self.embeddings, self.viterbi_decoder)
    ...
    def finalize(self):
        ...
        """
        print("TritonFastNERTagger cleaning up...")
